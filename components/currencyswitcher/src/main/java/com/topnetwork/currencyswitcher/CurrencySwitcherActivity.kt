...
/**
 * @FileName     : CurrencySwitcherActivity
 * @date         : 2020/6/9 17:48
 * @author       : Owen
 * @description  :
 */
class CurrencySwitcherActivity : CoreActivity(), CurrencySwitcherAdapter.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = ViewModelProvider(
            this,
            CurrencySwitcherModule.Factory()
        ).get(CurrencySwitcherPresenter::class.java)
...
class CurrencySwitcherAdapter(private var listener: Listener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            VIEW_TYPE_ITEM -> ViewHolderCurrency(
                inflater.inflate(
                    ViewHolderCurrency.layoutResourceId,
                    parent,
                    false
                )
            )
...
class ViewHolderCurrency(override val containerView: View) : RecyclerView.ViewHolder(containerView),
    LayoutContainer {
