...
import com.topnetwork.pin.R

/**
 * @FileName     : NumPadItemsAdapter
...
class NumPadItemsAdapter(
    ...
    override fun getItemCount(): Int = numPadItems.count()
    ...
    fun bind(
        ...
        when (item.type) {
            ...
            NumPadItemType.NUMBER -> {
                ...
                txtLetters.visibility =
                    if (item.number == 0 || !showLetters) View.GONE else View.VISIBLE
