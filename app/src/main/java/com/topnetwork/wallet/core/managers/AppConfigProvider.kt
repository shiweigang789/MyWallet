...
import com.topnetwork.core.IAppConfigTestMode
...
class AppConfigProvider: IAppConfigProvider, ILanguageConfigProvider, IAppConfigTestMode {
    ...
    override val companyWebPageLink: String
        get() = "https://horizontalsystems.io"
    override val appWebPageLink: String
        get() = "https://unstoppable.money"
    override val reportEmail: String
        get() = "hsdao@protonmail.ch"
    override val walletHelpTelegramGroup: String
        get() = "UnstoppableWallet"
    override val ipfsId: String
        get() = "QmXTJZBMMRmBbPun6HFt3tmb3tfYF2usLPxFoacL7G5uMX"
    override val ipfsMainGateway: String
        get() = "ipfs-ext.horizontalsystems.xyz"
    override val ipfsFallbackGateway: String
        get() = "ipfs.io"
    override val infuraProjectId: String?
        get() = "2a1306f1d12f4c109a4d4fb9be46b02e"
    override val infuraProjectSecret: String?
        get() = "fc479a9290b64a84a15fa6544a130218"


    override val fiatDecimal: Int
        get() = 2
    override val maxDecimal: Int
        get() = 8
